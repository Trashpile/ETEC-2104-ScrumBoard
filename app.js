...
function startServer(){
    ...
    app.post("/uploadpic", (req,res) => {
        ...
        F.parse(req, (err,fields,files) => {
            ...
            let profilepic = fields["pic"];
            let commaindex = profilepic.indexOf(",");
            profilepic = profilepic.substring(commaindex+1);
    
            let binarydata = Buffer.from(profilepic, "base64")
    
            
            fs.writeFile("./pub/profilepic.png", binarydata, function (err) {
                if (err) throw err;
