...
class Account
{
    ...
    // SetUser(uname){
    //     var str_length = uname.length;
    //     if (str_length <= 0){
    //         //No string inputted
    //         return false;
    //     }

    //     else if (str_length > 10){
    ...
    {
        // Either of these can be reenabled for testing
        
        //Had to remove due to multiple users not being able to be logged in at once
        // if (this.isLoggedIn === false)
        // {
        //     //not logged in
        //     return false;
        ...
        //Had to remove this due to having no good way to generate a new user ID
    ...
    acceptFriendRequest(uID, other)
    {
        ...
        else (this.requestsReceived.has(uID))
        {
