...
describe("MemeManager.js", () => {
    describe("addMeme()", () => {
        ...
        it("should return 1 if add is successful", (done) => {
            MM.addMeme("2019/01/03", (result) => {
                assert.strictEqual(result,1);
                done();
            })
        })
        it("should return -1 if add is unsuccessful", (done) => {
            MM.addMeme("01/03/2019", (result) => {
                assert.strictEqual(result,-1);
                done();
            })
        })
        it("should return -1 if add is unsuccessful", (done) => {
            MM.addMeme("2019/00/32", (result) => {
                assert.strictEqual(result,-1);
                done();
            })
        })
        it("should return -1 if add is unsuccessful", (done) => {
            MM.addMeme("yyyy/mm/dd", (result) => {
                assert.strictEqual(result,-1);
                done();
            })
        })
        it("should return -1 if add is unsuccessful", (done) => {
            MM.addMeme(1032019, (result) => {
                assert.strictEqual(result,-1);
                done();
            })
        })
